...
// src/app/stacjonarne/program/services/program.service.ts
var ProgramService = class _ProgramService {
  ...
  static \u0275fac = function ProgramService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ProgramService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ProgramService, factory: _ProgramService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ProgramService, [{
    type: Injectable,
    args: [{ providedIn: "root" }]
  }], null, null);
})();

// src/app/stacjonarne/program/program.component.ts
...
function ProgramComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ProgramComponent_Conditional_2_For_35_Template(rf, ctx) {
  if (rf & 1) {
...
function ProgramComponent_Conditional_2_For_38_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ProgramComponent_Conditional_2_For_38_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ProgramComponent_Conditional_2_For_38_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
...
function ProgramComponent_Conditional_2_For_38_ng_template_6_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
function ProgramComponent_Conditional_2_For_38_ng_template_6_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 39);
    \u0275\u0275listener("onClick", function ProgramComponent_Conditional_2_For_38_ng_template_6_Conditional_21_Template_p_button_onClick_0_listener() {
      \u0275\u0275restoreView(_r4);
      const rowData_r3 = \u0275\u0275nextContext().rowData;
...
function ProgramComponent_Conditional_2_For_38_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "td");
    \u0275\u0275conditionalCreate(6, ProgramComponent_Conditional_2_For_38_ng_template_6_Conditional_6_Template, 1, 2, "p-tag", 36);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "td");
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275conditionalCreate(21, ProgramComponent_Conditional_2_For_38_ng_template_6_Conditional_21_Template, 1, 0, "p-button", 38);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ProgramComponent_Conditional_2_For_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-tabpanel", 14)(1, "div", 15);
    \u0275\u0275conditionalCreate(2, ProgramComponent_Conditional_2_For_38_Conditional_2_Template, 2, 1, "p")(3, ProgramComponent_Conditional_2_For_38_Conditional_3_Template, 3, 0, "p", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p-treeTable", 17);
    \u0275\u0275template(5, ProgramComponent_Conditional_2_For_38_ng_template_5_Template, 18, 0, "ng-template", 18)(6, ProgramComponent_Conditional_2_For_38_ng_template_6_Template, 22, 17, "ng-template", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275element(7, "hr", 20);
...
function ProgramComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4)(1, "h1", 5);
    \u0275\u0275text(2, "Program studi\xF3w \u2013 studia stacjonarne");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(34, ProgramComponent_Conditional_2_For_35_Template, 2, 2, "p-tab", 14, _forTrack0);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "p-tabpanels");
    \u0275\u0275repeaterCreate(37, ProgramComponent_Conditional_2_For_38_Template, 35, 11, "p-tabpanel", 14, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ProgramComponent_Conditional_4_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function ProgramComponent_Conditional_4_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ProgramComponent_Conditional_4_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ProgramComponent_Conditional_4_Conditional_3_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
...
function ProgramComponent_Conditional_4_Conditional_3_ng_template_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 60);
    \u0275\u0275element(1, "i", 62);
    \u0275\u0275elementStart(2, "span");
...
function ProgramComponent_Conditional_4_Conditional_3_ng_template_33_Template(rf, ctx) {
  if (rf & 1) {
...
function ProgramComponent_Conditional_4_Conditional_3_ng_template_34_Template(rf, ctx) {
  if (rf & 1) {
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_36_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_36_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-panel", 53)(1, "p-table", 64);
    \u0275\u0275template(2, ProgramComponent_Conditional_4_Conditional_3_Conditional_36_ng_template_2_Template, 5, 0, "ng-template", 18)(3, ProgramComponent_Conditional_4_Conditional_3_Conditional_36_ng_template_3_Template, 5, 2, "ng-template", 19);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const s_r7 = \u0275\u0275nextContext();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_37_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-panel", 54)(1, "ul", 66);
    \u0275\u0275repeaterCreate(2, ProgramComponent_Conditional_4_Conditional_3_Conditional_37_For_3_Template, 2, 1, "li", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const s_r7 = \u0275\u0275nextContext();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_38_For_2_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_38_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, ProgramComponent_Conditional_4_Conditional_3_Conditional_38_For_2_For_5_Template, 2, 1, "li", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const entry_r12 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(2, 1, entry_r12.forma), ":");
    \u0275\u0275advance(3);
    \u0275\u0275repeater(entry_r12.metody);
  }
}
function ProgramComponent_Conditional_4_Conditional_3_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-panel", 55);
    \u0275\u0275repeaterCreate(1, ProgramComponent_Conditional_4_Conditional_3_Conditional_38_For_2_Template, 6, 3, null, null, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const s_r7 = \u0275\u0275nextContext();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_39_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "th", 65);
    \u0275\u0275text(2, "Przedmiot");
    \u0275\u0275elementEnd();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_39_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-panel", 56)(1, "p-table", 64);
    \u0275\u0275template(2, ProgramComponent_Conditional_4_Conditional_3_Conditional_39_ng_template_2_Template, 5, 0, "ng-template", 18)(3, ProgramComponent_Conditional_4_Conditional_3_Conditional_39_ng_template_3_Template, 5, 2, "ng-template", 19);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const s_r7 = \u0275\u0275nextContext();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_40_Conditional_1_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_40_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "ul", 66);
    \u0275\u0275repeaterCreate(4, ProgramComponent_Conditional_4_Conditional_3_Conditional_40_Conditional_1_For_5_Template, 2, 1, "li", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_40_Conditional_2_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_40_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 68);
    \u0275\u0275element(1, "i", 70);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "ul", 66);
    \u0275\u0275repeaterCreate(4, ProgramComponent_Conditional_4_Conditional_3_Conditional_40_Conditional_2_For_5_Template, 2, 1, "li", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const s_r7 = \u0275\u0275nextContext(2);
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_40_Conditional_3_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_40_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 68);
    \u0275\u0275element(1, "i", 71);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "ul", 66);
    \u0275\u0275repeaterCreate(4, ProgramComponent_Conditional_4_Conditional_3_Conditional_40_Conditional_3_For_5_Template, 2, 1, "li", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const s_r7 = \u0275\u0275nextContext(2);
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-panel", 57);
    \u0275\u0275conditionalCreate(1, ProgramComponent_Conditional_4_Conditional_3_Conditional_40_Conditional_1_Template, 6, 0);
    \u0275\u0275conditionalCreate(2, ProgramComponent_Conditional_4_Conditional_3_Conditional_40_Conditional_2_Template, 6, 0);
    \u0275\u0275conditionalCreate(3, ProgramComponent_Conditional_4_Conditional_3_Conditional_40_Conditional_3_Template, 6, 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const s_r7 = \u0275\u0275nextContext();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_41_For_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-panel", 58)(1, "ol", 66);
    \u0275\u0275repeaterCreate(2, ProgramComponent_Conditional_4_Conditional_3_Conditional_41_For_3_Template, 2, 1, "li", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const s_r7 = \u0275\u0275nextContext();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_42_Conditional_1_For_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_42_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 72);
    \u0275\u0275text(1, "Podstawowa:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "ul", 66);
    \u0275\u0275repeaterCreate(3, ProgramComponent_Conditional_4_Conditional_3_Conditional_42_Conditional_1_For_4_Template, 2, 1, "li", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const s_r7 = \u0275\u0275nextContext(2);
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_42_Conditional_2_For_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_42_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 72);
    \u0275\u0275text(1, "Uzupe\u0142niaj\u0105ca:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "ul", 66);
    \u0275\u0275repeaterCreate(3, ProgramComponent_Conditional_4_Conditional_3_Conditional_42_Conditional_2_For_4_Template, 2, 1, "li", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const s_r7 = \u0275\u0275nextContext(2);
...
function ProgramComponent_Conditional_4_Conditional_3_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-panel", 59);
    \u0275\u0275conditionalCreate(1, ProgramComponent_Conditional_4_Conditional_3_Conditional_42_Conditional_1_Template, 5, 0);
    \u0275\u0275conditionalCreate(2, ProgramComponent_Conditional_4_Conditional_3_Conditional_42_Conditional_2_Template, 5, 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const s_r7 = \u0275\u0275nextContext();
...
function ProgramComponent_Conditional_4_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 43)(1, "p-card", 50);
    \u0275\u0275template(2, ProgramComponent_Conditional_4_Conditional_3_ng_template_2_Template, 4, 0, "ng-template", 18);
    ...
    \u0275\u0275text(24);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(25, ProgramComponent_Conditional_4_Conditional_3_Conditional_25_Template, 4, 1);
    ...
    \u0275\u0275template(31, ProgramComponent_Conditional_4_Conditional_3_ng_template_31_Template, 4, 0, "ng-template", 18);
    \u0275\u0275elementStart(32, "p-table", 51);
    \u0275\u0275template(33, ProgramComponent_Conditional_4_Conditional_3_ng_template_33_Template, 15, 0, "ng-template", 18)(34, ProgramComponent_Conditional_4_Conditional_3_ng_template_34_Template, 16, 7, "ng-template", 19);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(35, ProgramComponent_Conditional_4_Conditional_3_Conditional_35_Template, 3, 3, "p-panel", 52);
    \u0275\u0275conditionalCreate(36, ProgramComponent_Conditional_4_Conditional_3_Conditional_36_Template, 4, 4, "p-panel", 53);
    \u0275\u0275conditionalCreate(37, ProgramComponent_Conditional_4_Conditional_3_Conditional_37_Template, 4, 2, "p-panel", 54);
    \u0275\u0275conditionalCreate(38, ProgramComponent_Conditional_4_Conditional_3_Conditional_38_Template, 3, 2, "p-panel", 55);
    \u0275\u0275conditionalCreate(39, ProgramComponent_Conditional_4_Conditional_3_Conditional_39_Template, 4, 4, "p-panel", 56);
    \u0275\u0275conditionalCreate(40, ProgramComponent_Conditional_4_Conditional_3_Conditional_40_Template, 4, 5, "p-panel", 57);
    \u0275\u0275conditionalCreate(41, ProgramComponent_Conditional_4_Conditional_3_Conditional_41_Template, 4, 2, "p-panel", 58);
    \u0275\u0275conditionalCreate(42, ProgramComponent_Conditional_4_Conditional_3_Conditional_42_Template, 3, 4, "p-panel", 59);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const s_r7 = ctx;
...
function ProgramComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ProgramComponent_Conditional_4_Conditional_0_Template, 4, 0, "div", 40);
    \u0275\u0275conditionalCreate(1, ProgramComponent_Conditional_4_Conditional_1_Template, 28, 8, "div", 41);
    \u0275\u0275conditionalCreate(2, ProgramComponent_Conditional_4_Conditional_2_Template, 4, 0, "div", 42);
    \u0275\u0275conditionalCreate(3, ProgramComponent_Conditional_4_Conditional_3_Template, 43, 21, "div", 43);
  }
  if (rf & 2) {
    let tmp_4_0;
    const ctx_r4 = \u0275\u0275nextContext();
...
function ProgramComponent_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r20 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 73);
    \u0275\u0275listener("onClick", function ProgramComponent_ng_template_5_Template_p_button_onClick_0_listener() {
      \u0275\u0275restoreView(_r20);
      const ctx_r4 = \u0275\u0275nextContext();
...
var ProgramComponent = class _ProgramComponent {
  ...
  static \u0275fac = function ProgramComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ProgramComponent)(\u0275\u0275directiveInject(ProgramService), \u0275\u0275directiveInject(HttpClient));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProgramComponent, selectors: [["app-program"]], decls: 6, vars: 13, consts: [[1, "program-page"], [1, "loading-info"], [3, "visibleChange", "onHide", "visible", "header", "modal", "contentStyle", "draggable", "resizable"], ["pTemplate", "footer"], [1, "total-summary"], [1, "page-title"], [1, "total-summary-title"], [1, "total-summary-items"], [1, "total-summary-item"], [1, "total-summary-label"], [1, "total-summary-value", "ects-value"], [1, "summary-separator"], [1, "total-summary-value"], [3, "value", "scrollable"], [3, "value"], [1, "semester-description"], [1, "description-placeholder"], ["styleClass", "p-treetable-sm semester-table", 3, "value", "columns", "showGridlines"], ["pTemplate", "header"], ["pTemplate", "body"], [1, "summary-divider"], [1, "semester-summary"], [1, "summary-item"], [1, "summary-label"], [1, "summary-value", "ects-value"], [1, "summary-value"], [1, "summary-item", "total-hours"], [2, "width", "30%"], [2, "width", "12%"], [2, "width", "6%"], [1, "text-center", 2, "width", "6%"], [2, "width", "8%"], [1, "text-center", 2, "width", "5%"], [2, "width", "11%"], [3, "ttRow"], [3, "rowNode"], ["styleClass", "type-tag", 3, "value", "severity"], [1, "text-center"], ["label", "Szczeg\xF3\u0142y", "icon", "pi pi-info-circle", "size", "small", "severity", "primary"], ["label", "Szczeg\xF3\u0142y", "icon", "pi pi-info-circle", "size", "small", "severity", "primary", 3, "onClick"], [1, "sylabus-loading"], [1, "sylabus-brak"], [1, "detail-placeholder"], [1, "sylabus-container"], ["strokeWidth", "4", "styleClass", "sylabus-spinner"], ["header", "Informacje podstawowe", "styleClass", "sylabus-panel", 3, "toggleable"], [1, "sylabus-info-grid"], [1, "info-label"], [1, "pi", "pi-info-circle", 2, "margin-right", "0.5rem"], [1, "pi", "pi-exclamation-triangle", 2, "margin-right", "0.5rem"], ["styleClass", "sylabus-card"], ["styleClass", "p-datatable-sm sylabus-hours-table", 3, "value", "showGridlines"], ["header", "Cel dydaktyczny", "styleClass", "sylabus-panel", 3, "toggleable", "collapsed"], ["header", "Forma zaliczenia", "styleClass", "sylabus-panel", 3, "toggleable", "collapsed"], ["header", "Kryteria oceny", "styleClass", "sylabus-panel", 3, "toggleable", "collapsed"], ["header", "Metody dydaktyczne", "styleClass", "sylabus-panel", 3, "toggleable", "collapsed"], ["header", "Przedmioty wprowadzaj\u0105ce", "styleClass", "sylabus-panel", 3, "toggleable", "collapsed"], ["header", "Efekty kszta\u0142cenia", "styleClass", "sylabus-panel", 3, "toggleable", "collapsed"], ["header", "Tre\u015Bci programowe", "styleClass", "sylabus-panel", 3, "toggleable", "collapsed"], ["header", "Literatura", "styleClass", "sylabus-panel", 3, "toggleable", "collapsed"], [1, "sylabus-card-header"], [1, "pi", "pi-book"], [1, "pi", "pi-clock"], [1, "sylabus-text"], ["styleClass", "p-datatable-sm", 3, "value", "showGridlines"], [2, "width", "40%"], [1, "sylabus-list"], [1, "metody-forma-label"], [1, "efekty-kategoria"], [1, "pi", "pi-lightbulb"], [1, "pi", "pi-cog"], [1, "pi", "pi-users"], [1, "literatura-typ"], ["label", "Zamknij", "icon", "pi pi-times", 3, "onClick"]], template: function ProgramComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275conditionalCreate(1, ProgramComponent_Conditional_1_Template, 2, 0, "div", 1);
      \u0275\u0275conditionalCreate(2, ProgramComponent_Conditional_2_Template, 39, 7);
      \u0275\u0275elementStart(3, "p-dialog", 2);
      \u0275\u0275listener("visibleChange", function ProgramComponent_Template_p_dialog_visibleChange_3_listener($event) {
        return ctx.dialogVisible.set($event);
      })("onHide", function ProgramComponent_Template_p_dialog_onHide_3_listener() {
        return ctx.closeDialog();
      });
      \u0275\u0275conditionalCreate(4, ProgramComponent_Conditional_4_Template, 4, 4);
      \u0275\u0275template(5, ProgramComponent_ng_template_5_Template, 1, 0, "ng-template", 3);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
\r
    ...
    <div class="total-summary">\r
      <h1 class="page-title">Program studi\xF3w \u2013 studia stacjonarne</h1>\r
...
\r
      <!-- Sylabus za\u0142adowany -->\r
      @if (!sylabusLoading() && sylabus(); as s) {\r
        <div class="sylabus-container">\r
\r
          <!-- 1. Informacje og\xF3lne (Card) -->\r
          <p-card styleClass="sylabus-card">\r
            <ng-template pTemplate="header">\r
              <div class="sylabus-card-header">\r
                <i class="pi pi-book"></i>\r
                <span>Informacje og\xF3lne</span>\r
              </div>\r
            </ng-template>\r
            <div class="sylabus-info-grid">\r
              <span class="info-label">Kod przedmiotu:</span>\r
              <span><strong>{{ s.kod_przedmiotu }}</strong></span>\r
\r
              <span class="info-label">Kierunek:</span>\r
              <span>{{ s.kierunek }} \xB7 profil {{ s.profil }}</span>\r
\r
              <span class="info-label">Tryb studi\xF3w:</span>\r
              <span>{{ s.tryb_studiow }}</span>\r
\r
              <span class="info-label">Rok / Semestr:</span>\r
              <span>{{ s.rok_studiow }} / {{ s.semestr_studiow }}</span>\r
\r
              <span class="info-label">Forma:</span>\r
              <span>{{ s.obligatoryjny ? 'Obowi\u0105zkowy' : 'Obieralny' }}</span>\r
\r
              @if (s.odpowiedzialny_za_przedmiot) {\r
                <span class="info-label">Odpowiedzialny:</span>\r
                <span>{{ s.odpowiedzialny_za_przedmiot }}</span>\r
              }\r
\r
              <span class="info-label">Wersja z dnia:</span>\r
              <span>{{ s.wersja_z_dnia }}</span>\r
            </div>\r
          </p-card>\r
\r
          <!-- 2. Godziny i ECTS (Card z tabel\u0105) -->\r
          <p-card styleClass="sylabus-card">\r
            <ng-template pTemplate="header">\r
              <div class="sylabus-card-header">\r
                <i class="pi pi-clock"></i>\r
                <span>Godziny i punkty ECTS</span>\r
              </div>\r
            </ng-template>\r
            <p-table [value]="[s]" styleClass="p-datatable-sm sylabus-hours-table" [showGridlines]="true">\r
              <ng-template pTemplate="header">\r
                <tr>\r
                  <th>Wyk\u0142ady</th>\r
                  <th>\u0106wiczenia / Lektorat</th>\r
                  <th>Laboratorium / Projekt</th>\r
                  <th>Z prowadz\u0105cym</th>\r
                  <th>Praca w\u0142asna</th>\r
                  <th>\u0141\u0105cznie</th>\r
                  <th>ECTS</th>\r
                </tr>\r
              </ng-template>\r
          ...
          @if (getZaliczenieEntries(s.zaliczenie).length > 0) {\r
            <p-panel header="Forma zaliczenia" [toggleable]="true" [collapsed]="false" styleClass="sylabus-panel">\r
              <p-table [value]="getZaliczenieEntries(s.zaliczenie)" styleClass="p-datatable-sm" [showGridlines]="true">\r
                <ng-template pTemplate="header">\r
                  <tr>\r
                    <th style="width:40%">Forma zaj\u0119\u0107</th>\r
                    <th>Spos\xF3b zaliczenia</th>\r
                  </tr>\r
                </ng-template>\r
                <ng-template pTemplate="body" let-row>\r
                  <tr>\r
...
\r
          ...
          @if (s.kryteria_oceny?.length) {\r
            <p-panel header="Kryteria oceny" [toggleable]="true" [collapsed]="true" styleClass="sylabus-panel">\r
              <ul class="sylabus-list">\r
                @for (k of s.kryteria_oceny; track $index) {\r
                  <li>{{ k }}</li>\r
                }\r
              </ul>\r
            </p-panel>\r
          ...
          @if (getMetodyEntries(s.metody_dydaktyczne).length > 0) {\r
            <p-panel header="Metody dydaktyczne" [toggleable]="true" [collapsed]="true" styleClass="sylabus-panel">\r
              @for (entry of getMetodyEntries(s.metody_dydaktyczne); track entry.forma) {\r
                <p class="metody-forma-label">{{ entry.forma | titlecase }}:</p>\r
                <ul class="sylabus-list">\r
                  @for (m of entry.metody; track $index) {\r
                    <li>{{ m }}</li>\r
                  }\r
                </ul>\r
              }\r
          ...
          @if (s.przedmioty_wprowadzajace?.length) {\r
            <p-panel header="Przedmioty wprowadzaj\u0105ce" [toggleable]="true" [collapsed]="true" styleClass="sylabus-panel">\r
              <p-table [value]="s.przedmioty_wprowadzajace" styleClass="p-datatable-sm" [showGridlines]="true">\r
                <ng-template pTemplate="header">\r
                  <tr>\r
                    <th style="width:40%">Przedmiot</th>\r
                    <th>Wymagane zagadnienia</th>\r
                  </tr>\r
                </ng-template>\r
                <ng-template pTemplate="body" let-row>\r
                  <tr>\r
                    <td>{{ row.nazwa }}</td>\r
                    <td>{{ row.wymagania || '\u2013' }}</td>\r
                  </tr>\r
                </ng-template>\r
              </p-table>\r
            </p-panel>\r
          ...
          @if (s.efekty_ksztalcenia) {\r
            <p-panel header="Efekty kszta\u0142cenia" [toggleable]="true" [collapsed]="true" styleClass="sylabus-panel">\r
              @if (asArray(s.efekty_ksztalcenia.wiedza).length) {\r
                ...
                <ul class="sylabus-list">\r
                  @for (e of asArray(s.efekty_ksztalcenia.wiedza); track $index) {\r
                    <li>{{ e }}</li>\r
                  }\r
                </ul>\r
              }\r
              @if (asArray(s.efekty_ksztalcenia.umiejetnosci).length) {\r
                ...
                <ul class="sylabus-list">\r
                  @for (e of asArray(s.efekty_ksztalcenia.umiejetnosci); track $index) {\r
                    <li>{{ e }}</li>\r
                  }\r
                </ul>\r
              }\r
              @if (asArray(s.efekty_ksztalcenia.kompetencje_spoleczne).length) {\r
                ...
                <ul class="sylabus-list">\r
                  @for (e of asArray(s.efekty_ksztalcenia.kompetencje_spoleczne); track $index) {\r
                    <li>{{ e }}</li>\r
                  }\r
                </ul>\r
              }\r
...
\r
          ...
          @if (s.tresci_programowe?.length) {\r
            <p-panel header="Tre\u015Bci programowe" [toggleable]="true" [collapsed]="true" styleClass="sylabus-panel">\r
              <ol class="sylabus-list">\r
                @for (t of s.tresci_programowe; track $index) {\r
                  <li>{{ t }}</li>\r
                }\r
              </ol>\r
            </p-panel>\r
          ...
          @if (s.literatura) {\r
            <p-panel header="Literatura" [toggleable]="true" [collapsed]="true" styleClass="sylabus-panel">\r
              @if (s.literatura.podstawowa?.pozycje?.length) {\r
                ...
                <ul class="sylabus-list">\r
                  @for (p of s.literatura.podstawowa!.pozycje; track $index) {\r
                    <li>{{ p }}</li>\r
                  }\r
                </ul>\r
              }\r
              @if (s.literatura.uzupelniajaca?.pozycje?.length) {\r
                ...
                <ul class="sylabus-list">\r
                  @for (p of s.literatura.uzupelniajaca!.pozycje; track $index) {\r
                    <li>{{ p }}</li>\r
                  }\r
                </ul>\r
              }\r
...
`, styles: ["/* src/app/stacjonarne/program/program.component.css */\n.program-page {\n  margin-left: 15px;\n  margin-right: 1rem;\n  padding: 2rem 0;\n}\n.page-title {\n  font-size: 1.75rem;\n  font-weight: 700;\n  margin: 0 0 0.75rem 0;\n  color: #dc2626;\n}\n.loading-info {\n  text-align: center;\n  padding: 3rem;\n  color: #6b7280;\n  font-size: 1.1rem;\n}\n.semester-header {\n  font-weight: 600;\n  font-size: 0.9rem;\n}\n.semester-ects-badge {\n  margin-left: 0.5rem;\n  background: #dc2626;\n  color: #fff;\n  border-radius: 9999px;\n  padding: 0.1rem 0.6rem;\n  font-size: 0.75rem;\n  font-weight: 600;\n  vertical-align: middle;\n}\n.semester-description {\n  margin-bottom: 1rem;\n  padding: 0.75rem 1rem;\n  background: #fff5f5;\n  border-left: 4px solid #dc2626;\n  border-radius: 4px;\n  color: #374151;\n  font-size: 0.95rem;\n}\n.description-placeholder {\n  color: #9ca3af;\n  margin: 0;\n}\n.semester-table {\n  margin-bottom: 1rem;\n}\n.group-row td {\n  background: #fff5f5 !important;\n  font-weight: 600;\n}\n.group-label {\n  font-weight: 600;\n}\n.child-row td {\n  background: #fffafa;\n}\n.text-center {\n  text-align: center;\n}\n.type-tag {\n  font-size: 0.75rem;\n}\n.summary-divider {\n  border: none;\n  border-top: 2px solid #d1d5db;\n  margin: 0.75rem 0;\n}\n.total-summary {\n  margin-top: 0;\n  margin-bottom: 1.5rem;\n  padding: 1rem 1.25rem;\n  background: #ffffff;\n  border-radius: 8px;\n  border: 1px solid #e5e7eb;\n  border-left: 4px solid #dc2626;\n}\n.total-summary-title {\n  font-weight: 700;\n  font-size: 0.85rem;\n  color: #6b7280;\n  display: block;\n  margin-bottom: 0.75rem;\n  text-transform: uppercase;\n  letter-spacing: 0.05em;\n}\n.total-summary-items {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 1.25rem;\n  align-items: center;\n}\n.total-summary-item {\n  display: flex;\n  align-items: center;\n  gap: 0.4rem;\n}\n.total-summary-label {\n  color: #6b7280;\n  font-size: 0.875rem;\n}\n.total-summary-value {\n  font-weight: 700;\n  font-size: 1rem;\n  color: #111827;\n}\n.semester-summary {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 1.25rem;\n  align-items: center;\n  padding: 0.75rem 1rem;\n  background: #e5e7eb;\n  border-radius: 6px;\n  border: 1px solid #d1d5db;\n  margin-top: 0.5rem;\n}\n.summary-item {\n  display: flex;\n  align-items: center;\n  gap: 0.4rem;\n}\n.summary-label {\n  color: #6b7280;\n  font-size: 0.875rem;\n}\n.summary-value {\n  font-weight: 600;\n  font-size: 0.95rem;\n  color: #111827;\n}\n.ects-value {\n  font-size: 1.1rem;\n  color: #dc2626;\n}\n.summary-separator {\n  width: 1px;\n  height: 24px;\n  background: #d1d5db;\n}\n.total-hours {\n  margin-left: auto;\n}\n.detail-placeholder {\n  margin-top: 1rem;\n  padding: 1rem;\n  background: #fff5f5;\n  border-radius: 6px;\n  color: #991b1b;\n  font-size: 0.9rem;\n  display: flex;\n  align-items: center;\n}\n.sylabus-loading {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 1rem;\n  padding: 2.5rem 0;\n  color: #6b7280;\n}\n.sylabus-spinner {\n  width: 48px !important;\n  height: 48px !important;\n}\n.sylabus-container {\n  display: flex;\n  flex-direction: column;\n  gap: 0.75rem;\n  padding: 0.25rem 0;\n}\n.sylabus-card-header {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  font-weight: 600;\n  font-size: 0.95rem;\n  padding: 0.75rem 1rem 0 1rem;\n  color: #b91c1c;\n}\n.sylabus-card :deep(.p-card-body) {\n  padding: 0.5rem 1rem 1rem 1rem;\n}\n.sylabus-info-grid {\n  display: grid;\n  grid-template-columns: 180px 1fr;\n  gap: 0.35rem 0.75rem;\n  font-size: 0.875rem;\n}\n.info-label {\n  font-weight: 600;\n  color: #6b7280;\n  align-self: baseline;\n}\n.sylabus-hours-table :deep(th),\n.sylabus-hours-table :deep(td) {\n  font-size: 0.8rem !important;\n  padding: 0.4rem 0.5rem !important;\n  text-align: center;\n}\n.sylabus-panel :deep(.p-panel-header) {\n  background: #1f2937 !important;\n  color: #f9fafb !important;\n  padding: 0.6rem 1rem;\n  font-size: 0.9rem;\n  font-weight: 600;\n  border-radius: 6px 6px 0 0;\n}\n.sylabus-panel :deep(.p-panel-header .p-panel-header-icon) {\n  color: #f9fafb !important;\n}\n.sylabus-panel :deep(.p-panel-content) {\n  padding: 0.75rem 1rem;\n  background: #111827;\n  color: #e5e7eb;\n  border-radius: 0 0 6px 6px;\n  font-size: 0.875rem;\n}\n.sylabus-text {\n  line-height: 1.6;\n  margin: 0;\n}\n.sylabus-list {\n  margin: 0.25rem 0 0 0;\n  padding-left: 1.25rem;\n  line-height: 1.7;\n}\n.sylabus-list li {\n  margin-bottom: 0.2rem;\n}\n.metody-forma-label {\n  font-weight: 600;\n  color: #9ca3af;\n  margin: 0.5rem 0 0.15rem 0;\n  text-transform: capitalize;\n  font-size: 0.8rem;\n  letter-spacing: 0.03em;\n}\n.efekty-kategoria {\n  font-weight: 600;\n  color: #9ca3af;\n  margin: 0.6rem 0 0.2rem 0;\n  font-size: 0.85rem;\n  display: flex;\n  align-items: center;\n  gap: 0.4rem;\n}\n.literatura-typ {\n  font-weight: 600;\n  color: #9ca3af;\n  margin: 0.5rem 0 0.2rem 0;\n  font-size: 0.82rem;\n}\n/*# sourceMappingURL=program.component.css.map */\n"] }]
  }], () => [{ type: ProgramService }, { type: HttpClient }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ProgramComponent, { className: "ProgramComponent", filePath: "src/app/stacjonarne/program/program.component.ts", lineNumber: 40 });
})();
export {
  ProgramComponent
};
//# sourceMappingURL=chunk-W77DL2VP.js.map
